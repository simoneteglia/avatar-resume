	...
	if (windowSize > 900) {
			...
			<div style={{ zIndex: 10 }}>
				...
				>
					...
					<p style={{ maxWidth: "60ch" }}>
						...
						quis rem maxime facilis error? Eligendi delectus perferendis, autem
						commodi nam similique minus voluptate illum accusantium magnam
						veritatis excepturi officiis.
					</p>
				</div>
				<div
					id="contact-me"
		...
		return (
			<div style={{ zIndex: 10 }}>
				...
				>
					<h1>Whoami</h1>
					<p style={{ maxWidth: "60ch", fontSize: "35px", lineHeight: "40px" }}>
						Hi! I'm Simone Teglia, a front end enthusiast and software engineer.
						At Sapienza University in Rome, I'm now enrolled in my first year of
						the Master of Science in Engineering in Computer Science program. My
						main interests are machine learning and natural langage processing.
